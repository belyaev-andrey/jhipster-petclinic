...
@RestController
@RequestMapping("/api/jhpetclinic-kafka")
public class JhpetclinicKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhpetclinicKafkaResource.class);
    ...
    public JhpetclinicKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
